...
- Из-за stateless архитектуры текущая реализация не поддерживает транзакции, охватывающие несколько HTTP-запросов
- Для планируемых транзакций и сложных операций потребуется реализация stateful соединений (постоянных или "припаркованных")
